...
import frc.robot.swerve_library.math.PIDBase;
...
public class PIDController extends PIDBase implements Controller
{
     ...
     * @param period
     *                   the loop time for doing calculations in seconds. This
     *                   particularly affects calculations of the integral and
     *                   differential terms. The default is 0.05 (50ms).
     */
    @SuppressWarnings("ParameterName")
    public PIDController(double Kp, double Ki, double Kd, double Kf, double kIZone, double kIMax, PIDSource source,
            PIDOutput output, double period)
    {
        super(Kp, Ki, Kd, Kf, kIZone, kIMax, source, output);
    ...
    {
        this(Kp, Ki, Kd, Kf, 0.0, 0.0, source, output, period);
    }
