...
public class PIDBase extends SendableBase implements PIDInterface, PIDOutput
{
    ...
    // Zone for "integral" control
    @SuppressWarnings("MemberName")
    private double m_iZone;

    // Max "integral" control
    @SuppressWarnings("MemberName")
    ...
    public PIDBase(double Kp, double Ki, double Kd, double Kf, double kIZone, double kIMax, PIDSource source,
            PIDOutput output)
    {
        super(false);
    ...
    {
        this(Kp, Ki, Kd, 0.0, 0.0, 0.0, source, output);
    }
    ...
    protected void calculate()
    {
        ...
        if (enabled)
        {
            ...
            else
            {
                ...
                result = P * error + totalI + D * (error - prevError) + feedForward;
            }
     ...
     *                  Feed forward coefficient
     * @param iZone
     *                  Integral coefficient zone
     */
    @SuppressWarnings("ParameterName")
    public void setPID(double p, double i, double d, double f, double iZone)
    {
        m_thisMutex.lock();
        try
        {
    ...
    @SuppressWarnings("ParameterName")
    public void setPID(double p, double i, double d, double f, double iZone, double iMax)
    {
        m_thisMutex.lock();
        try
        {
    ...
    /**
     * Set the I Zone of the PID controller .
     *
     * @param iZone
     *                  I term zone.
     */
    ...
    /**
     * Set the I Max of the PID controller .
     *
     * @param iMax
     *                 The max the I term can be.
     */
    @SuppressWarnings("ParameterName")
     ...
     * @param tolerance
     *                      A tolerance object of the right type, e.g.
     ...
     *
     * @param absvalue
     *                     absolute error which is tolerable in the units of the
     *                     input object
     */
    ...
    {
        builder.setSmartDashboardType("Custom PID");
        ...
        builder.addDoubleProperty("i max", this::getIMax, this::setIMax);
