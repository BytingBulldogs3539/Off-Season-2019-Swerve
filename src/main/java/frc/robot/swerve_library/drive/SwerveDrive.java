...
import frc.robot.swerve_library.math.*;
...
public class SwerveDrive
{
    ...
    public SwerveDrive(SwerveEnclosure swerveEnclosure1, SwerveEnclosure swerveEnclosure2,
            SwerveEnclosure swerveEnclosure3, SwerveEnclosure swerveEnclosure4, double width, double length)
    {
