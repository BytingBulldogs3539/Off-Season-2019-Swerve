...
public class SwerveUtils
{
	...
	/**
	 * Convert encoder value from whatever the encoder returns to the -0.5 - +0.5
	 * range expected by the math library The encoder is assumed to be continuous in
	 * the sense that it keeps counting beyond one turn and can go to negative
	 * values as well
	 * 
	 * @param encoderValue
